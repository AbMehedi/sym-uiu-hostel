...
class RegistrationController extends AbstractController
{
    ...
    public function register(
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($firstName === '' || $lastName === '' || $email === '' || $password === '' || !$idCardPicture || !$nidOrBirthCert) {
            ...
            // Real student number (UIU-YYYY-XXXX) is assigned automatically when admin approves.
            $student->setStudentNumber('PENDING-' . bin2hex(random_bytes(4)));
